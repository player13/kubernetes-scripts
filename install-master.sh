...
kubeadm init --pod-network-cidr=10.244.0.0/16 --apiserver-advertise-address="192.168.56.200" # add --apiserver-advertise-address="ip" if you want to use a different IP address than the main server IP
export KUBECONFIG=/etc/kubernetes/admin.conf
